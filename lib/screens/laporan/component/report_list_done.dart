...
class ReportListDone extends StatefulWidget {
  const ReportListDone({super.key});

  @override
  State<ReportListDone> createState() => _ReportListDoneState();
}

class _ReportListDoneState extends State<ReportListDone> {
  @override
  void initState() {
    super.initState();
    SchedulerBinding.instance.addPostFrameCallback((_) {
      Provider.of<ReportProvider>(context, listen: false).fetchReportsByLaporanSelesai();
    });
  }
